...
export default async function TeamsDirectoryPage() {
  ...
  return (
    <PageContainer>
      <PageHeader 
        title="League Franchises"
        subtitle="Directory of all teams and managers in the dynasty league."
      />
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 mt-auto pb-4">
                <div className="bg-slate-100 text-slate-600 border border-slate-200 px-2 py-1 rounded text-[10px] font-bold tracking-widest uppercase flex items-center gap-1.5 shadow-sm">
                  MLB <span className="text-slate-900">{mlb}</span>
                </div>
                <div className="bg-orange-50 text-orange-700 border border-orange-200 px-2 py-1 rounded text-[10px] font-bold tracking-widest uppercase flex items-center gap-1.5 shadow-sm">
                ...
                {il > 0 && (
                  <div className="bg-red-50 text-red-700 border border-red-200 px-2 py-1 rounded text-[10px] font-bold tracking-widest uppercase flex items-center gap-1.5 shadow-sm">
                    IL <span className="text-red-900">{il}</span>
                  </div>
                )}
                {na > 0 && (
                  <div className="bg-slate-100 text-slate-500 border border-slate-200 px-2 py-1 rounded text-[10px] font-bold tracking-widest uppercase flex items-center gap-1.5 shadow-sm">
