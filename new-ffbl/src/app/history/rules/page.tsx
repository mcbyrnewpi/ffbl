...
export const metadata: Metadata = {
  title: "League Rules | FFBL",
  description: "The official constitution and rulebook of the Franklin Fantasy Baseball League.",
};
    ...
    <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden relative">
      ...
      {doc ? (
        ...
        <div className="p-16 text-center">
          ...
          <h3 className="text-lg font-bold text-slate-900">Rulebook Empty</h3>
          <p className="text-slate-500 font-medium mt-1">
            The Commissioner has not published the league rules yet.
          </p>
        </div>
      )}
    </div>
