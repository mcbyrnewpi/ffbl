...
export const metadata: Metadata = {
  title: "Player Records | FFBL Archives",
  description: "The greatest single-week individual performances in FFBL history.",
};
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-8 md:p-12 relative overflow-hidden">
      ...
      <div className="flex items-center gap-3 mb-8 border-b border-slate-100 pb-6">
        ...
        <h2 className="text-3xl font-black text-slate-900 tracking-tight">Individual Records</h2>
      </div>
              ...
              <div className="space-y-3">
                {group.map((record) => (
                  <div key={record.id} className="border-t border-slate-200/60 pt-3 flex flex-col">
                    {/* The player name and team from the seed data */}
                    <span className="font-bold text-blue-700 leading-snug">{record.recordHolder}</span>
