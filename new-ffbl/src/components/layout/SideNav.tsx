...
import { Users, LayoutDashboard, ArrowRightLeft, Shield, Search, Menu, X, LogOut, LogIn, ShieldAlert, Activity, BookOpen, Gavel } from 'lucide-react';
...
export default function SideNav() {
  ...
  const navLinks = [
    ...
    { href: '/draft', icon: <Gavel size={18} />, label: 'Draft Room' },
